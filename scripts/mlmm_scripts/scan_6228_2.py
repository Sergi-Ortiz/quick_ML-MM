...
def perform_step(atoms, l, frame, SCAN_DIR, H_idx, C_idx, O_idx, k, rc_step, opt_thereshold=0.05, opt_steps=10000, frozen_idx=[]):
    ...
    atoms.set_constraint([harmonic_c, freeze_c])
...
save_it = 25                 # how often to save pdb and energy (in opt iterations). Debug: 1. Default: 10


# scan options
rc_thereshold = 2.0         # stop scan when rc thereshold is reached
visualize = False
rst_frame = None            # frame from which to restart the scan (must be in the src dir). Default: None
energy_ref = None           # value of the energy (in eV) of rst_frame. Default: None
#300, 900, 2620
