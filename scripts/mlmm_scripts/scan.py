...
# new config, no li quedava força, poso una k més gran. Mteixes settings
k = 1.5 * 291.54                  # eV/Å^2
rc_step = 0.0025              # Å
opt_thereshold = 0.02        # eV / Å
save_it = 5                 # how often to save pdb and energy (in opt iterations). Debug: 1. Default: 10
...
# scan options
rc_thereshold = 0.2         # stop scan when rc thereshold is reached
visualize = False
rst_frame = 1131            # frame from which to restart the scan (must be in the src dir). Default: None
energy_ref = -155331.492982           # value of the energy (in eV) of rst_frame. Default: None
