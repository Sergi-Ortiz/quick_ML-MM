...
The setup uses the MD trajectory to extract precatalytic frames, according to a 'precatalytic definition', from which QM/MM scans are used to determine the energetic contribution to the free energy barrier, $\DeltaG^\ddag$.
